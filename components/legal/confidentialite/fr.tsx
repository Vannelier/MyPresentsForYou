...
const confidentialite: ContenuLegal = {
  titreMeta: "Politique de confidentialité — MyPresentsForYou",
  descriptionMeta:
  ...
  chapo:
    "MyPresentsForYou est construit pour avoir le moins de données possible à protéger. Cette page dit exactement lesquelles, et pourquoi elles existent.",
  Corps: ({ langue }) => (
    <>
