...
const conditions: ContenuLegal = {
  titreMeta: "Conditions d'utilisation — MyPresentsForYou",
  descriptionMeta:
  ...
  chapo:
    "Le service est gratuit et sans compte. Voici ce sur quoi nous nous engageons, et ce que nous te demandons en retour.",
  Corps: ({ langue }) => (
    <>
