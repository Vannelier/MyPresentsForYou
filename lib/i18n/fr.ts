...
export const fr = {
  ...
  creation: {
    ...
    rienNestFige: "Tant que personne n'a pas choisi, ta page reste modifiable.",
    lienRecuperation: "Ton lien de récupération",
    lienRecuperationFort: "Garde-le précieusement",
    modalTexte:
      "Il n'est affiché qu'ici, et c'est le seul moyen de revenir voir le cadeau choisi. Sauvegarde-le quelque part avant de continuer.",
    modalBouton: "J'ai sauvegardé ce lien",
    lienEnvoi: "Lien à envoyer à la personne",
    reprendre: "Reprendre la modification",
    voirPublique: "Voir la page publique",
    cartesMemorisee:
      "Ce lien est aussi gardé sur cet appareil : tu le retrouveras sur la page d'accueil.",
    impressionOuvrir: "Envie d'une carte-cadeau à imprimer ?",
  ...
  editeur: {
    ...
    cadeauxAide:
      "Jusqu'à {max} idées, dans l'ordre que tu veux. Si le cadeau s'achète en ligne : colle l'adresse d'un produit pour en récupérer le titre et l'image. Sinon décris-le toi-même.",
    ...
    noteFacultatif: "Facultatif",
    ajouter: "+ Ajouter un cadeau",
    idees: {
      titre: "Besoin d'idées ?",
      aide: "Quelques idées en fonction du profil de la personne.",
      aideOccasion: "{occasion} : quelques idées en fonction du profil de la personne.",
