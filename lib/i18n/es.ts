...
export const es = {
  ...
  site: {
    titreMeta: "MyPresentsForYou — la página regalo personalizada",
    descriptionMeta: "Un regalo que sale de lo común para cualquier ocasión: una página personalizada con tus ideas. Envías el enlace, la otra persona elige, tú regalas.",
  ...
  banniere: {
    titre: "Un regalo que sale de lo común, para cualquier ocasión.",
    texte: "Pones unas cuantas ideas de regalo en una página hecha para una sola persona. La abre, elige, y tú compras.",
    pied: "Gratis, y sin cuenta que crear.",
  },
  ...
  accueil: {
    ...
    donnees: {
      ...
      description:
        "Crea una página regalo personalizada con tus ideas de regalo, envía el enlace y deja que la otra persona elija lo que quiere.",
      fonctions: [
    ...
    titre: "Crea una página regalo personalizada, envíala y deja que la otra persona elija lo que quiere.",
    sousTitre:
    ...
    etapes: [
      {
        titre: "Creas su página",
        texte:
          "Eliges la ocasión y la página toma sus colores. Luego añades tus ideas: pegas el enlace de un producto y el título y la foto suelen llegar solos. Si no, una foto hecha con el móvil sirve igual.",
      },
      {
        titre: "Envías el enlace o lo imprimes",
        texte:
          "Enviado por WhatsApp o por SMS, el enlace llega con tu mensaje y su nombre, no como una dirección pelada. También puedes imprimir el código QR y meterlo en un sobre, para estar ahí cuando se abra la página.",
      },
      {
        titre: "Descubres su elección",
        texte:
          "Tu enlace privado te dice qué regalo se ha elegido, y cuándo. Con el mensaje que te hayan dejado. Después solo te queda comprarlo.",
      },
    ],
    avantages: [
      {
    ...
    objections: [
      {
        ...
        texte: "Ningún pago pasa por el sitio. Compras el regalo donde quieras, como siempre.",
      },
      {
        titre: "Sin cuenta",
        texte:
          "Nada que crear, ni para ti ni para la otra persona. Abre el enlace y elige, sin dar nombre ni dirección.",
      },
      {
    ...
    piedNote:
      "Una tarjeta permanece en línea un año. Guarda tu enlace privado: es el que te dirá qué se ha elegido.",
  },

  creation: {
    titreMeta: "Crea una página regalo gratis — MyPresentsForYou",
    descriptionMeta:
      "Crea una página regalo personalizada en tres pasos: la ocasión y su decoración, tus ideas de regalo y la presentación. Sin cuenta, sin pago.",
    titre: "Crea tu página regalo",
    pret: "Tu página está lista",
    rienNestFige: "Mientras nadie haya elegido, tu página sigue siendo modificable.",
    lienRecuperation: "Tu enlace de recuperación",
    lienRecuperationFort: "Guárdalo con cuidado",
    modalTexte:
      "Solo se muestra aquí y es la única forma de volver a ver el regalo elegido. Guárdalo en algún sitio antes de continuar.",
    modalBouton: "He guardado este enlace",
    lienEnvoi: "Enlace para enviar a la otra persona",
    reprendre: "Seguir editando",
    voirPublique: "Ver la página pública",
    cartesMemorisee:
      "Este enlace también se guarda en este dispositivo: lo encontrarás en la página de inicio.",
    impressionOuvrir: "¿Te apetece una tarjeta regalo para imprimir?",
  ...
  exemple: {
    ...
    descriptionMeta:
      "Una página regalo real para probar: levanta el velo y elige entre cuatro ideas. No se envía nada.",
  ...
  editeur: {
    ...
    cadeauxAide:
      "Hasta {max} ideas, en el orden que quieras. Si el regalo se compra en línea: pega la dirección de un producto para recuperar su título y su imagen. Si no, descríbelo tú mismo.",
